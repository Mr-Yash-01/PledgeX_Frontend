...
export default function ProjectCard({ project }: ProjectCardProps) {
    ...
    return (
        <div className="rounded-2xl shadow-sm  shadow-gray-800 flex flex-col gap-2 p-4 cursor-pointer my-4 lg:flex lg:flex-row lg:justify-around">
            <div className="flex flex-col gap-1 lg:w-1/2">
                <h2 className="font-bold text-2xl font-body md:text-3xl lg:text-4xl">Project Name</h2>
                <hr className="w-full opacity-10" />
                <h6 className="flex items-center gap-2 md:text-lg lg:text-xl"><MdCategory /> Catageroy</h6>
